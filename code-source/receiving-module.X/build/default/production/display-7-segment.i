...
void Display7SegmentText(unsigned char *text, unsigned char decimal_point)
{
    ...
    if(enable_digit<=1)
    {
        ...
        {
            OneDigitHandler(*text,1,1);
        }else
        {
            OneDigitHandler(*text,1,0);
        }
        enable_digit=2;
    ...
    }else if(enable_digit==2)
    {
        ...
        {
            OneDigitHandler(*(text+1),2,1);
        }else
        {
            OneDigitHandler(*(text+1),2,0);
        }
        enable_digit=3;
    ...
    }else if(enable_digit==3)
    {
        ...
        {
           OneDigitHandler(*(text+2),3,1);
        }else
        {
           OneDigitHandler(*(text+2),3,0);
        }
        enable_digit=4;
    ...
    }else if(enable_digit>=4)
    {
        ...
        {
            OneDigitHandler(*(text+3),4,1);
        }else
        {
            OneDigitHandler(*(text+3),4,0);
        }
        enable_digit=1;
    }
