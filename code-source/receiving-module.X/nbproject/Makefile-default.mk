...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/receiving-module.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=circular_buffer.c crc16.c hw_uart.c inits.c interrupts.c main.c manchester_decode.c melody.c utils.c display-7-segment.c pcf8583.c hw_i2c.c key-handler.c menu.c flash.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/circular_buffer.p1 ${OBJECTDIR}/crc16.p1 ${OBJECTDIR}/hw_uart.p1 ${OBJECTDIR}/inits.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/manchester_decode.p1 ${OBJECTDIR}/melody.p1 ${OBJECTDIR}/utils.p1 ${OBJECTDIR}/display-7-segment.p1 ${OBJECTDIR}/pcf8583.p1 ${OBJECTDIR}/hw_i2c.p1 ${OBJECTDIR}/key-handler.p1 ${OBJECTDIR}/menu.p1 ${OBJECTDIR}/flash.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/circular_buffer.p1.d ${OBJECTDIR}/crc16.p1.d ${OBJECTDIR}/hw_uart.p1.d ${OBJECTDIR}/inits.p1.d ${OBJECTDIR}/interrupts.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/manchester_decode.p1.d ${OBJECTDIR}/melody.p1.d ${OBJECTDIR}/utils.p1.d ${OBJECTDIR}/display-7-segment.p1.d ${OBJECTDIR}/pcf8583.p1.d ${OBJECTDIR}/hw_i2c.p1.d ${OBJECTDIR}/key-handler.p1.d ${OBJECTDIR}/menu.p1.d ${OBJECTDIR}/flash.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/circular_buffer.p1 ${OBJECTDIR}/crc16.p1 ${OBJECTDIR}/hw_uart.p1 ${OBJECTDIR}/inits.p1 ${OBJECTDIR}/interrupts.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/manchester_decode.p1 ${OBJECTDIR}/melody.p1 ${OBJECTDIR}/utils.p1 ${OBJECTDIR}/display-7-segment.p1 ${OBJECTDIR}/pcf8583.p1 ${OBJECTDIR}/hw_i2c.p1 ${OBJECTDIR}/key-handler.p1 ${OBJECTDIR}/menu.p1 ${OBJECTDIR}/flash.p1

# Source Files
SOURCEFILES=circular_buffer.c crc16.c hw_uart.c inits.c interrupts.c main.c manchester_decode.c melody.c utils.c display-7-segment.c pcf8583.c hw_i2c.c key-handler.c menu.c flash.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/receiving-module.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/receiving-module.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/receiving-module.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1    -fno-short-double -fno-short-float -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -mrom=default,-1f00-1ffe -mram=default,-0-0,-70-70,-80-80,-f0-f0,-100-100,-170-170,-180-180,-1e5-1f0  $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/receiving-module.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/receiving-module.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/receiving-module.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/receiving-module.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1    -fno-short-double -fno-short-float -O2 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/receiving-module.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
